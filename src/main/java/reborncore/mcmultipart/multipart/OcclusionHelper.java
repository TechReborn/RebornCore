...
public class OcclusionHelper {
	 ...
	 * @param other The part to test against.
	 ...
	 *
	 * @param part The part to test.
	 * @param others The parts to test against.
	 * @return True if they don't occupy the same space, false if they do.
	 */
	 ...
	 *
	 * @param part The part to test.
	 * @param container The multipart container to test against.
	 * @return True if they don't occupy the same space, false if they do.
	 */
	 ...
	 *
	 * @param part The part to test.
	 * @param ignored The parts to ignore.
	 * @param others The parts to test against.
	 * @return True if they don't occupy the same space, false if they do.
	 */
	 ...
	 * @param parts The parts to test against.
	...
	public static boolean slotOcclusionTest(PartSlot slot, Predicate<IMultipart> ignored, IMultipart... parts) {
		...
		for (IMultipart part : parts)
			if ((ignored == null || !ignored.apply(part))
				&& ((part instanceof ISlottedPart && ((ISlottedPart) part).getSlotMask().contains(slot))
	 ...
	 *
	 * @param parts The parts to be ignored.
	...
	/**
	 * Returns a {@link NormallyOccludingPart} that occludes the specified boxes. <b>The output of this method is not meant to be cached</b>
	 * , since every time the method is called the boxes that the object occupies will change. If you need to cache the result, create your
	 * own instance of {@link NormallyOccludingPart} by using the constructor.
	 *
	 * @param boxes The boxes to be occluded.
