...
public abstract class Crops
{
	...
	@Deprecated
	public abstract boolean registerBaseSeed(final ItemStack p0, final int p1, final int p2, final int p3, final int p4,
			final int p5);

	public abstract boolean registerBaseSeed(final ItemStack p0, final CropCard p1, final int p2, final int p3,
