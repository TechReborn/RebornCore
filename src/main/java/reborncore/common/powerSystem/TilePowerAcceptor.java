...
import api.energy.event.EnergyTileUnloadEvent;
import api.energy.tile.IEnergySink;
import api.energy.tile.IEnergySource;
import api.energy.tile.IEnergySourceInfo;
import api.energy.tile.IEnergyTile;
import api.info.Info;
...
//    }
    ...
    public int receiveEnergy(EnumFacing from, int maxReceive, boolean simulate) {
        ...
        int energyReceived = Math.min(getMaxEnergyStored(null) - getEnergyStored(null), Math.min((int) this.getMaxInput() * PowerSystem.euPerRF, maxReceive));
