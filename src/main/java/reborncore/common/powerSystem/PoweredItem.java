...
public abstract class PoweredItem {
	...
	public static void registerPoweredItem(String itemclass){
		...
		MixinManager.registerMixin(new MixinTargetData("reborncore.common.powerSystem.mixin.RFItemPowerMixin", itemclass));
		if(Loader.isModLoaded("IC2")){
			MixinManager.registerMixin(new MixinTargetData("reborncore.common.powerSystem.mixin.EUItemPowerMixin", itemclass));
		}
	}
