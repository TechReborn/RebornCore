...
public class Annotation
{
	 ...
	 * <br/>
	 * When a mixin uses the class this is applied to as the base, JTraits will
	 * make sure the trait {@link #value()} is applied at the end.
	 */
	 ...
	 * <br/>
	 * When a mixin uses the class this is applied to as the base, JTraits will
	 * try to set the boolean variable {@link #value()} to true.
	 */
	@Target(ElementType.TYPE)
	@Retention(RetentionPolicy.RUNTIME)
