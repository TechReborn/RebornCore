...
public class MixinRenderItem {
	...
	public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, @Nullable
		String text) {
		if(stack != null){
			if(stack.getItem() instanceof IColoredDamageBar){
				if(((IColoredDamageBar) stack.getItem()).showRGBDurabilityBar(stack)){
					...
					this.draw(vertexbuffer, xPosition + 2, yPosition + 13, j, 1, rgbfordisplay >> 16 & 255, rgbfordisplay >> 8 & 255, rgbfordisplay & 255, 255);
