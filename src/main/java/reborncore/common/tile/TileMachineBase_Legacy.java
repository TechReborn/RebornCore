...
public class TileMachineBase_Legacy extends TileEntity implements ITickable, IInventory, ISidedInventory
{
	...
	protected Optional<IInventory> getInventoryForTile(){
