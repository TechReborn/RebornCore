...
public class BaseSeed
{
	...
	public BaseSeed(final CropCard crop, final int size, final int statGrowth, final int statGain,
			final int statResistance, final int stackSize)
	{
		this.crop = crop;
	...
	public BaseSeed(final int id, final int size, final int statGrowth, final int statGain, final int statResistance,
			final int stackSize)
	{
