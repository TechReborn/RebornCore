...
public class ContainerTileInventoryBuilder
{
	 ...
	 * @return
	 */
	public ContainerTileInventoryBuilder filterSlot(final int index, final int x, final int y, final Predicate<ItemStack> filter)
	{
	 ...
	 * @return
	 */
	public ContainerTileInventoryBuilder syncBooleanValue(final Supplier<Boolean> supplier, final Consumer<Boolean> setter)
	{
	 ...
	 * @return
	 */
	public ContainerTileInventoryBuilder syncIntegerValue(final Supplier<Integer> supplier, final Consumer<Integer> setter)
	{
	 ...
	 * @return
	 */
	public ContainerTileInventoryBuilder syncFluidValue(final Supplier<FluidStack> supplier, final Consumer<FluidStack> setter)
	{
	 ...
	 * @return
	 */
	public ContainerTileInventoryBuilder syncItemValue(final Supplier<ItemStack> supplier, final Consumer<ItemStack> setter)
	{
