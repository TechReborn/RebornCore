...
public class Inventory implements IInventory
{
	...
	{
		if (slotId < contents.length && contents[slotId] != ItemStack.field_190927_a)
		{
			if (contents[slotId].func_190916_E() > count)
			{
	...
	{
		if (this.contents[slotId] == ItemStack.field_190927_a)
		{
