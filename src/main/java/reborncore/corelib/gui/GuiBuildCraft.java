...
import reborncore.corelib.client.render.RenderUtils;
...
public abstract class GuiBuildCraft extends GuiContainer {
    ...
    public void drawFluid(FluidStack fluid, int x, int y, int width, int height, int maxCapacity) {
        ...
        TextureAtlasSprite sprite = FluidRenderer.getFluidTexture(fluid.getFluid(), FluidRenderer.FluidType.STILL);
    ...
    private static void vertexUV(VertexBuffer wr, double x, double y, double z, double u, double v) {
