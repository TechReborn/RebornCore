...
public class Inventory implements IInventory
{
	...
	public Inventory(String inventoryName, int inventorySize, int inventoryStackLimit) {
	...
	public Inventory(String inventoryName, int inventorySize, int inventoryStackLimit, TileEntity tileEntity) {
		this(inventoryName, inventorySize, inventoryStackLimit);
	...
	public ItemStack getStackInSlot(int slotId) {
		return slotId < this.getSizeInventory() ? this.inventoryContent[slotId] : null;
	}
	...
	public void markDirty() {
		...
		if(this.tileEntity instanceof IInventoryUpdateable) {
			((IInventoryUpdateable) this.tileEntity).updateInventory();
		}
		IBlockState state = this.tileEntity.getWorld().getBlockState(this.tileEntity.getPos());
		this.tileEntity.getWorld().notifyBlockUpdate(this.tileEntity.getPos(), state, state, 3);
	}
