...
public final class ForgeCompatibility
{
	public static boolean tryLog(String data)
	{
		try
		{
			org.apache.logging.log4j.LogManager.getLogger("JavaChecker").log(org.apache.logging.log4j.Level.ERROR,
					data);
			return true;
		} catch (Throwable t)
		{ // apache logging is not available
			t.printStackTrace();
		}
	...
	{
		return new File(ForgeCompatibility.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath())
				.getName();
	}
}
