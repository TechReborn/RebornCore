...
package reborncore.corelib.client.render;
...
public enum RenderUtils {
    ...
    private RenderUtils() {
        rotations.put(EnumFacing.UP, new Vec3d(0, 0, 0));
    ...
    public static void vertex3f(Vec3d vec) {
        vertex3f(new Vector3f((float) vec.xCoord, (float) vec.yCoord, (float) vec.zCoord));
    }
